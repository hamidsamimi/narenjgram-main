...
import powergram.CustomLanguageSelectActivity;
...
public class IntroActivity extends Activity {
    ...
    private void start(){
        ...
        language.setText(LocaleController.getString("ChangeLanguage", R.string.ChangeLanguage));


        View LanguageSelect = findViewById(R.id.LanguageSelect);


        LanguageSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(IntroActivity.this, CustomLanguageSelectActivity.class), 1);
                start();
            }
        });
    ...
    private class IntroAdapter extends PagerAdapter {
        ...
        public void setPrimaryItem(ViewGroup container, int position, Object object) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (a == position) {
                    //child.setBackgroundColor(0xFF477295);
