        ...
        if (type == 4) {
            ...
            if (needPhonebook) {
                if (position == 0) {
                    ...
                    actionCell.setTextAndIcon(spaceStr+LocaleController.getString("NewContact", R.string.NewContact), R.drawable.menu_invite);
                }
            } else if (isAdmin) {
            ...
            if (contact.first_name != null && contact.last_name != null) {
                ((TextCell) convertView).setText(spaceStr + contact.first_name + " " + contact.last_name);
            } else if (contact.first_name != null && contact.last_name == null) {
                ((TextCell) convertView).setText(spaceStr +contact.first_name);
            } else {
                ((TextCell) convertView).setText(spaceStr +contact.last_name);
            }
        } else if (type == 0) {
            if (convertView == null) {
