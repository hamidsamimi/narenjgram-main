...
public class DialogCell extends BaseCell {
    ...
    private final GradientDrawable statusBG;
    ...
    private final ArrayList<TLRPC.TL_dialog> dialogsCats = new ArrayList<>();
    ...
    private void setStatusColor() {
        ...
        } else if (s.equalsIgnoreCase(LocaleController.getString("Online", R.string.Online))) {
            //Powergram
    ...
    private void updateTheme() {
        ...
        int tColor = themePrefs.getInt("themeColor2", 0xff4ecc5e);
        int dColor = AndroidUtilities.getIntDarkerColor("themeColor", 0x15);

        int nColor = themePrefs.getInt("chatsNameColor", 0xff212121);

        Theme.dialogs_namePaint.setTextSize(AndroidUtilities.dp(themePrefs.getInt("chatsNameSize", 17)));
        Theme.dialogs_namePaint.setColor(nColor);
...
//        groupPaint.setColor(themePrefs.getInt("chatsGroupNameColor", nColor));
        ...
        Theme.dialogs_lockDrawable.setColorFilter(themePrefs.getInt("chatsGroupIconColor", themePrefs.getInt("chatsNameColor", tColor)), PorterDuff.Mode.SRC_IN);

        Theme.dialogs_nameEncryptedPaint.setTextSize(AndroidUtilities.dp(themePrefs.getInt("chatsNameSize", 17)));
        Theme.dialogs_nameEncryptedPaint.setColor(themePrefs.getInt("chatsNameColor", dColor));//0xff00a60e
...
//        nameUnknownPaint.setColor(themePrefs.getInt("chatsUnknownNameColor", nColor));//0xff4d83b3
        ...
        Theme.dialogs_messagePaint.setTextSize(AndroidUtilities.dp(themePrefs.getInt("chatsMessageSize", 16)));
        Theme.dialogs_messagePaint.setColor(themePrefs.getInt("chatsMessageColor", 0xff8f8f8f));

        Theme.dialogs_messagePrintingPaint.setTextSize(AndroidUtilities.dp(themePrefs.getInt("chatsMessageSize", 16)));
        Theme.dialogs_messagePrintingPaint.setColor(themePrefs.getInt("chatsMessageColor", tColor));
...
//        messageTypingPaint.setColor(themePrefs.getInt("chatsTypingColor", tColor));
        ...
        Theme.dialogs_timePaint.setTextSize(AndroidUtilities.dp(themePrefs.getInt("chatsTimeSize", 13)));
        Theme.dialogs_timePaint.setColor(themePrefs.getInt("chatsTimeColor", 0xff999999));

        Theme.dialogs_countPaint.setTextSize(AndroidUtilities.dp(themePrefs.getInt("chatsCountSize", 13)));
        Theme.dialogs_countPaint.setColor(themePrefs.getInt("chatsCountColor", 0xffc7c7c7));

        Theme.dialogs_checkDrawable.setColorFilter(themePrefs.getInt("chatsChecksColor", tColor), PorterDuff.Mode.SRC_IN);
        Theme.dialogs_halfCheckDrawable.setColorFilter(themePrefs.getInt("chatsChecksColor", tColor), PorterDuff.Mode.SRC_IN);
        Theme.dialogs_clockDrawable.setColorFilter(themePrefs.getInt("chatsChecksColor", tColor), PorterDuff.Mode.SRC_IN);

//        countDrawable.setColorFilter(themePrefs.getInt("chatsCountBGColor", tColor), PorterDuff.Mode.SRC_IN);
//        countDrawableGrey.setColorFilter(themePrefs.getInt("chatsCountSilentBGColor",  0xffb9b9b9), PorterDuff.Mode.SRC_IN);

        nColor = themePrefs.getInt("chatsGroupIconColor", themePrefs.getInt("chatsGroupNameColor", 0xff000000));
        Theme.dialogs_groupDrawable.setColorFilter(nColor, PorterDuff.Mode.SRC_IN);
//        Theme.dialogs_superGroupDrawable.setColorFilter(nColor, PorterDuff.Mode.SRC_IN);
        Theme.dialogs_broadcastDrawable.setColorFilter(nColor, PorterDuff.Mode.SRC_IN);
        Theme.dialogs_botDrawable.setColorFilter(nColor, PorterDuff.Mode.SRC_IN);

        int mColor = themePrefs.getInt("chatsMuteColor", 0xffa8a8a8);
        //muteWhiteDrawable.setColorFilter(mColor, PorterDuff.Mode.MULTIPLY);
        Theme.dialogs_muteDrawable.setColorFilter(mColor, PorterDuff.Mode.SRC_IN);

        Theme.dividerPaint.setColor(themePrefs.getInt("chatsDividerColor", 0xffdcdcdc));
    ...
    private static void setChecks(Context context) {
        ...
        if (check.equals(ImageListActivity.getCheckName(1))) {
            ...
            Theme.dialogs_checkDrawable = context.getResources().getDrawable(R.drawable.dialogs_check);
            Theme.dialogs_halfCheckDrawable = context.getResources().getDrawable(R.drawable.dialogs_halfcheck);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawStatus && !themePrefs.getBoolean("chatsHideStatusIndicator", false)) {
            if (LocaleController.isRTL) {
                setDrawableBounds(statusBG, getMeasuredWidth() - AndroidUtilities.dp(36) + avatarLeftMargin, AndroidUtilities.dp(46), AndroidUtilities.dp(16), AndroidUtilities.dp(16));
            } else {
