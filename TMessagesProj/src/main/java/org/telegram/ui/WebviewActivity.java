        ...
        public void postEvent(final String eventName, final String eventData) {
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    ...
                    showDialog2(new ShareAlert(getParentActivity(), currentMessageObject, null, false, null , true));
                }
            });
        }
    }
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    currentMessageObject.messageOwner.with_my_score = false;
                    showDialog2(new ShareAlert(getParentActivity(), currentMessageObject, null, false, linkToCopy , true));
                } else if (id == open_in) {
