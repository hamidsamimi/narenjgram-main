...
public class ChatAttachView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    private static class AttachButton extends FrameLayout {
        ...
        public AttachButton(Context context) {
            ...
            textView.setTextColor(themePrefs.getInt("chatAttachTextColor", 0xff757575));
    ...
    public ChatAttachView(Context context) {
        ...
        SharedPreferences themePrefs = ApplicationLoader.applicationContext.getSharedPreferences(AndroidUtilities.THEME_PREFS, AndroidUtilities.THEME_PREFS_MODE);
        int color = themePrefs.getInt("chatAttachBGColor", 0xffffffff);
        setBackgroundColor(color);
        int val = themePrefs.getInt("chatAttachBGGradient", 0);
        if(val > 0) {
            ...
            int gradColor = themePrefs.getInt("chatAttachBGGradientColor", 0xffffffff);
        ...
        lineView.setBackgroundColor(color == 0xffffffff ? 0xffd2d2d2 : color);
