...
public class ActionBar extends FrameLayout {
    ...
    public void createGhostModeImage() {
        ...
        this.ghostView.setImageDrawable(getResources().getDrawable(R.drawable.ic_ghost));
        this.ghostView.setPadding(20, 60, 20, 20);
        addView(this.ghostView , LayoutHelper.createFrame(AndroidUtilities.dp(30), AndroidUtilities.dp(30), Gravity.TOP | Gravity.CENTER));
    }
