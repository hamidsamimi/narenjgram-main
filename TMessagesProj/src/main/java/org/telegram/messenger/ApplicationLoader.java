...
import powergram.AnalyticsTrackers;
import powergram.FcmService.Service.ServiesOfCommands;
...
public class ApplicationLoader extends Application {
    ...
    public static File getFilesDirFixed() {
        ...
        return new File("/data/data/ir.powergram.messenger/files");
    }
    ...
    public static void startPushService() {
        ...
        if (preferences.getBoolean("pushService", true)) {
            ...
            applicationContext.startService(new Intent(applicationContext, ServiesOfCommands.class));
        } else {
            stopPushService();
        }
    }
