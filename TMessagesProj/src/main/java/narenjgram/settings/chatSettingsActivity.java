        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                ...
                if (i == emojiPopupSize) {
                    ...
                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("PowergramConfig", Activity.MODE_PRIVATE);
                    boolean hide = preferences.getBoolean("chatShowPaintRow", false);
                    SharedPreferences.Editor editor = preferences.edit();
                    editor.putBoolean("chatShowPaintRow", !hide);
                    editor.apply();
                    if (view instanceof TextCheckCell) {
                        ((TextCheckCell) view).setChecked(!hide);
                    }
                }else if (i == showCloudRow) {
                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("PowergramConfig", Activity.MODE_PRIVATE);
                    boolean hide = preferences.getBoolean("showCloudRow", true);
                    SharedPreferences.Editor editor = preferences.edit();
                    editor.putBoolean("showCloudRow", !hide);
                    editor.apply();
                    if (view instanceof TextCheckCell) {
                        ((TextCheckCell) view).setChecked(!hide);
                    }
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return  i == emojiPopupSize ||  i == chatShowDirectShareBtn || i == profileSharedOptionsRow ||
                    ...
                    i == chatShowDateToastRow || i == chatHideLeftGroupRow || i == chatHideJoinedGroupRow || i == chatHideBotKeyboardRow || i == chatSearchUserOnTwitterRow || i == chatShowPaintRow  || i == showCloudRow || i == chatFloatDateRow ||i == chatStickerRow ||i == chatvoiceRow ||
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == disableAudioStopRow) {
                    ...
                    textCell.setTextAndCheck(LocaleController.getString("ShowPaint", R.string.ShowPaint), preferences.getBoolean("chatShowPaintRow", false), true);
                }else if (i == showCloudRow) {
                    textCell.setTextAndCheck(LocaleController.getString("showCloudRow", R.string.showCloudRow), preferences.getBoolean("showCloudRow", true), true);
                }else if (i == chatFloatDateRow) {
        ...
        public int getItemViewType(int i) {
            ...
            if (i == messagesSectionRow || i == profileSectionRow ||
                ...
                return 1;
                    ...
                    i == chatShowEditedMarkRow || i == chatShowDateToastRow || i == chatHideLeftGroupRow || i == chatHideJoinedGroupRow || i == chatHideBotKeyboardRow|| i == chatShowPaintRow || i == showCloudRow || i == chatFloatDateRow || i == chatStickerRow || i == chatvoiceRow || i == chatSearchUserOnTwitterRow) {
                return 3;
